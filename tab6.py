...
def run_tab(): 
    ...
    with tabs[0]: 
        pass 
        # 테이블 데이터
        df8_0, df8_1, df8_2, wc8  = mf.load_df(t6_organ, t6_kind1) 

        # map data  
        map_t1 = mf.load_map(t6_base_position, t6_organ, t6_kind1) 
        # mf.load_map_t6_kind1(t6_organ, t6_kind1, t6_base_position) 
