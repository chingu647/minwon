...
def load_df(organ, kind1):
    ...
    kind1_df['NUMBER_pct'] = month_df['NUMBER'] / month_df['NUMBER'].sum(axis=1) 
...
month_df, point_df, kind1_df, wc_data = load_df('본부','KIND1') 
st.write(month_df) 
st.write(kind1_df) 
...
#     fig = px.pie(point_df, values='', names='country',
