...
st.markdown(f"""
<center>2024년도 주요 민원 유형은 <font color='red'><b>{t50t1_kind1_df.index[0]}({t50t1_kind1_df.iloc[0,0]}건)</b> > {t50t1_kind1_df.index[1]} > {t50t1_kind1_df.index[2]} > {t50t1_kind1_df.index[3]} > {t50t1_kind1_df.index[4]}</font> 순 입니다.</center>
""", unsafe_allow_html=True) 
